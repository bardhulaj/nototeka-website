  ...
  return (
    <Section id="covenant" tone="light" innerClassName="pt-12 sm:pt-14 md:pt-16 lg:pt-20">
      <div className="mx-auto w-[70%]">
        <img src="/icons/bottom-piece-mobile.svg" alt="Held in the grace of those who carry it forward." className="w-full md:hidden" />
        <img src="/icons/bottom-piece.svg" alt="Held in the grace of those who carry it forward." className="hidden w-full md:block" />
      </div>
